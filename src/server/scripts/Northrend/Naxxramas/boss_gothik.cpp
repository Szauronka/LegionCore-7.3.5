...
public:
    ...
    struct boss_gothikAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC|UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        ...
        void JustSummoned(Creature *summon) override
        {
            ...
            {
                summon->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL|UNIT_FLAG_NOT_SELECTABLE);
        ...
        void DamageTaken(Unit* , uint32& damage, DamageEffectType dmgType) override
        {
            if (!phaseTwo)
                damage = 0;
        }
