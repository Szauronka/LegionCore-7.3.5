...
enum Achievements
{
    ACHIEV_IM_ON_A_BOAT_10      = 4536,
    ACHIEV_IM_ON_A_BOAT_25      = 4612
};
...
Player* SelectRandomPlayerFromLists(TPlayerLists &players)
{
    ...
    TPlayerLists::iterator itr = players.begin();
...
void StartFlyShip(Transport* ship)
{
    ...
    ship->SetParentRotation(parentRotation);
    Map* map = ship->GetMap();
    std::set<uint32> mapsUsed;

    GameObjectTemplate const* goinfo = ship->GetGOInfo();
    if (!goinfo)
        return;

    sTransportMgr->GeneratePath(goinfo, const_cast<TransportTemplate*>(ship->GetTransportTemplate()));
...
void RelocateTransport(Transport* transport)
{
    ...
    transport->Update(0);
    transport->UpdatePassengerPositions(transport->GetPassengers());
...
{
    if (Creature* capitan = ObjectAccessor::GetCreature(*me, instance->GetGuidData(data)))
        return capitan->GetTransport();
    else
        return NULL;
}
...
{
    for (WorldObjectSet::iterator itr = ship->GetPassengers().begin(); itr != ship->GetPassengers().end();)
    {
        auto obj = (*itr);
        if (obj->GetTypeId() == TYPEID_UNIT)
        {
            if (Creature* npc = obj->ToCreature())
            {
...
{
    firstShip->UnloadNonStaticPassengers();
    secondShip->UnloadNonStaticPassengers();
    firstShip->AddObjectToRemoveList();
    secondShip->AddObjectToRemoveList();
    ...
    {
        if (Transport* allianceHammerShip = sTransportMgr->CreateTransport(GO_ORGRIM_S_HAMMER_ALLIANCE_ICC, 0, instance))
        {
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_ORGRIMS_HAMMER, 1.845810f, 1.268872f, 34.526218f, 1.5890f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_HIGH_OVERLORD_SAURFANG, 37.18615f, 0.00016f, 36.78849f, 3.13683f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_INVISIBLE_STALKER, 37.18615f, 0.00016f, 36.78849f, 3.13683f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_BATTLE_MAGE, 47.2929f, -4.308941f, 37.5555f, 3.05033f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_BATTLE_MAGE, 47.34621f, 4.032004f, 37.70952f, 3.05033f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_BATTLE_MAGE, 15.03016f, 0.00016f, 37.70952f, 1.55138f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -13.19547f, -27.160213f, 35.47252f, 3.10672f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.33902f, -25.230491f, 33.04052f, 3.00672f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -60.1251f, -1.27014f, 42.8335f, 5.16073f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -48.2651f, 16.78034f, 34.2515f, 0.04292f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -14.8356f, 27.931688f, 33.363f, 1.73231f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 10.2702f, 20.62966f, 35.37483f, 1.6f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 39.32459f, 14.50176f, 36.88428f, 1.6f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 46.17223f, -6.638763f, 37.35444f, 1.32f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 27.4456f, -13.397498f, 36.34746f, 1.6f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 18.16184f, 1.37897f, 35.31705f, 1.6f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.11516f, -0.196236f, 45.15709f, 2.9f);
            allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.11844f, -0.19624f, 49.18192f, 1.6f);

            if (instance->ToInstanceMap()->GetMaxPlayers() == 10)
            {
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -3.170555f, 28.30652f, 34.21082f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -12.0928f, 27.65942f, 33.58557f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 14.92804f, 26.18018f, 35.47803f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 24.70331f, 25.36584f, 35.97845f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, -11.44849f, -25.71838f, 33.64343f, 1.49248f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, 12.30336f, -25.69653f, 35.32373f, 1.49248f);
            }
            else
            {
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -3.170555f, 28.30652f, 34.21082f, 1.66527f);
                ...
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 14.92804f, 26.18018f, 35.47803f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 24.70331f, 25.36584f, 35.97845f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 19.92804f, 27.18018f, 35.47803f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -7.70331f, 28.36584f, 33.88557f, 1.66527f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, -11.44849f, -25.71838f, 33.64343f, 1.49248f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, 12.30336f, -25.69653f, 35.32373f, 1.49248f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, -3.44849f, -25.71838f, 34.21082f, 1.49248f);
                allianceHammerShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, 3.30336f, -25.69653f, 35.32373f, 1.49248f);
            }

            allianceHammerShip->SetPendingStop(true);
            allianceHammerShip->SetMoving(false);
            /// TODO
            //allianceHammerShip->BuildStopMovePacket(allianceHammerShip->GetMap());
        }

        if (Transport* allianceSkyBreakerShip = sTransportMgr->CreateTransport(GO_THE_SKYBREAKER_ALLIANCE_ICC, 0, instance))
        {
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER, -17.156807f, -1.633260f, 20.81273f, 4.52672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_MURADIN_BRONZEBEARD, 13.51547f, -0.160213f, 20.87252f, 3.10672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_HIHG_CAPTAIN_JUSTIN_BARTLETT, 42.78902f, -0.010491f, 25.24052f, 3.00672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_HIGH_OVERLORD_SAURFANG_NOT_VISUAL, -12.9806f, -22.9462f, 21.659f, 4.72416f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ZAFOD_BOOMBOX, 18.8042f, 9.907914f, 20.33559f, 3.10672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_DECKHAND, -64.8423f, 4.4658f, 23.4352f, 2.698897f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_DECKHAND, 35.54972f, 19.93269f, 25.0333f, 4.71242f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_DECKHAND, -36.39837f, 3.13127f, 20.4496f, 1.5708f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_DECKHAND, -36.23974f, -2.75767f, 20.4506f, 4.69496f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_DECKHAND, 41.94677f, 44.08411f, 24.66587f, 1.62032f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 13.51547f, -0.160213f, 20.87252f, 3.10672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 42.78902f, -0.010491f, 25.24052f, 3.00672f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 14.0551f, 3.65014f, 20.7935f, 3.16073f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 14.0551f, -4.65034f, 20.7915f, 3.04292f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -17.8356f, 0.031688f, 20.823f, 4.73231f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -34.2702f, -26.18966f, 21.37483f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -11.64459f, -19.85176f, 20.88428f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -19.88223f, -6.578763f, 20.57444f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -41.4456f, -7.647498f, 20.49746f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 0.554884f, -1.232897f, 20.53705f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -50.16516f, 9.716236f, 23.58709f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 11.45844f, 16.36624f, 20.54192f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 19.72286f, -2.193787f, 33.06982f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 19.72286f, -2.193787f, 33.06982f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 8.599396f, -28.55855f, 24.79919f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 38.94339f, -33.808f,  25.39618f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 58.15474f, 0.748094f, 41.87663f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 5.607554f, -6.350654f, 34.00357f, 1.6f);
            allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 4.780305f, -29.05227f, 35.09634f, 1.6f);

            if (instance->ToInstanceMap()->GetMaxPlayers() == 10)
            {
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -5.15231f, -22.9462f, 21.659f, 4.72416f);
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -28.0876f, -22.9462f, 21.659f, 4.72416f);
            }
            else
            {
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -5.15231f, -22.9462f, 21.659f, 4.72416f);
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -14.9806f, -22.9462f, 21.659f, 4.72416f);
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -21.7406f, -22.9462f, 21.659f, 4.72416f);
                allianceSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_ALLIANCE_CANON, -28.0876f, -22.9462f, 21.659f, 4.72416f);
            }

            allianceSkyBreakerShip->SetPendingStop(true);
            allianceSkyBreakerShip->SetMoving(false);
            /// TODO
            //allianceSkyBreakerShip->BuildStopMovePacket(allianceHammerShip->GetMap());
        }
    }
    else if (teamInInstance == HORDE)
    {
        if (Transport* hordeSkyBreakerShip = sTransportMgr->CreateTransport(GO_THE_SKYBREAKER_HORDE_ICC, 0, instance))
        {
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER, -17.156807f, -1.633260f, 20.81273f, 4.52672f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_MURADIN_BRONZEBEARD, 13.51547f, -0.160213f, 20.87252f, 3.10672f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_HIHG_CAPTAIN_JUSTIN_BARTLETT, 42.78902f, -0.010491f, 25.24052f, 3.00672f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_SORCERERS, 14.0551f, 3.65014f, 20.7935f, 3.16073f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_SORCERERS, 14.0551f, -4.65034f, 20.7915f, 3.04292f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_SORCERERS, -17.8356f, 0.031688f, 20.823f, 4.73231f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 13.51547f, -0.160213f, 20.87252f, 3.10672f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 42.78902f, -0.010491f, 25.24052f, 3.00672f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 14.0551f, 3.65014f, 20.7935f, 3.16073f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 14.0551f, -4.65034f, 20.7915f, 3.04292f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -17.8356f, 0.031688f, 20.823f, 4.73231f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -34.2702f, -26.18966f, 21.37483f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -11.64459f, -19.85176f, 20.88428f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -19.88223f, -6.578763f, 20.57444f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -41.4456f, -7.647498f, 20.49746f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 0.554884f, -1.232897f, 20.53705f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -50.16516f, 9.716236f, 23.58709f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 11.45844f, 16.36624f, 20.54192f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 19.72286f, -2.193787f, 33.06982f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 19.72286f, -2.193787f, 33.06982f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 8.599396f, -28.55855f, 24.79919f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 38.94339f, -33.808f,  25.39618f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 58.15474f, 0.748094f, 41.87663f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 5.607554f, -6.350654f, 34.00357f, 1.6f);
            hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 4.780305f, -29.05227f, 35.09634f, 1.6f);

            if(instance->ToInstanceMap()->GetMaxPlayers() == 10)
            {
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -5.15231f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -14.9806f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -21.7406f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -28.0876f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -8.61003f, 15.483f, 20.4158f, 4.69854f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -27.9583f, 14.8875f, 20.4428f, 4.77865f);
            }
            else
            {
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, 0.15231f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -5.15231f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -14.9806f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -21.7406f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -28.0876f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_RIFLEMAN, -33.0876f, -22.9462f, 21.659f, 4.72416f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -8.61003f, 15.483f, 20.4158f, 4.69854f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -27.9583f, 14.8875f, 20.4428f, 4.77865f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -15.61003f, 15.483f, 20.4158f, 4.69854f);
                hordeSkyBreakerShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MORTAR_SOLDIER, -20.9583f, 14.8875f, 20.4428f, 4.77865f);
            }

            hordeSkyBreakerShip->SetPendingStop(true);
            hordeSkyBreakerShip->SetMoving(false);
            /// TODO
            //hordeSkyBreakerShip->BuildStopMovePacket(allianceHammerShip->GetMap());
        }

        if (Transport* hordeHammerShip = sTransportMgr->CreateTransport(GO_ORGRIM_S_HAMMER_HORDE_ICC, 0, instance))
        {
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_ORGRIMS_HAMMER, 1.845810f, 1.268872f, 34.526218f, 1.5890f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HIGH_OVERLORD_SAURFANG, 37.18615f, 0.00016f, 36.78849f, 3.13683f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_MURADIN_BRONZEBEARD_NOT_VISUAL, -7.09684f, 30.582f, 34.5013f, 1.53591f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_INVISIBLE_STALKER, 37.30764f, -0.143823f, 36.7936f, 3.13683f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_ZAFOD_BOOMBOX, 35.18615f, 15.30652f, 37.64343f, 3.05033f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -13.19547f, -27.160213f, 35.47252f, 3.10672f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.33902f, -25.230491f, 33.04052f, 3.00672f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -60.1251f, -1.27014f, 42.8335f, 5.16073f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -48.2651f, 16.78034f, 34.2515f, 0.04292f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -14.8356f, 27.931688f, 33.363f, 1.73231f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 10.2702f, 20.62966f, 35.37483f, 1.6f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 39.32459f, 14.50176f, 36.88428f, 1.6f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 46.17223f, -6.638763f, 37.35444f, 1.32f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 27.4456f, -13.397498f, 36.34746f, 1.6f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, 18.16184f, 1.37897f, 35.31705f, 1.6f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.11516f, -0.196236f, 45.15709f, 2.9f);
            hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_GUNSHIP_HULL, -18.11844f, -0.19624f, 49.18192f, 1.6f);

            if(instance->ToInstanceMap()->GetMaxPlayers() == 10)
            {
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, 22.6225f, 28.9309f, 36.3929f, 1.53591f);
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, -21.7509f, 29.4207f, 34.2588f, 1.53591f);
            }
            else
            {
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, 22.6225f, 28.9309f, 36.3929f, 1.53591f);
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, 9.87745f, 30.5047f, 35.7147f, 1.53591f);
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, -7.09684f, 30.582f, 34.5013f, 1.53591f);
                hordeHammerShip->AddNPCPassengerInInstance(NPC_GB_HORDE_CANON, -21.7509f, 29.4207f, 34.2588f, 1.53591f);
            }

            hordeHammerShip->SetPendingStop(true);
            hordeHammerShip->SetMoving(false);
            /// TODO
            //hordeHammerShip->BuildStopMovePacket(allianceHammerShip->GetMap());
        }
    }
}
...
void StopFight(Transport* t1, Transport* t2)
{
    ...
    for (WorldObjectSet::iterator itr = t1->GetPassengers().begin(); itr != t1->GetPassengers().end();)
    {
        auto obj = (*itr);
        if (obj->GetTypeId() == TYPEID_UNIT)
        {
    ...
    for (WorldObjectSet::iterator itr = t2->GetPassengers().begin(); itr != t2->GetPassengers().end();)
    {
        auto obj = (*itr);
        if (Creature *npc = obj->ToCreature())
        {
...
class npc_muradin_gunship : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (_instance->GetBossState(DATA_LADY_DEATHWHISPER) != DONE || _instance->GetBossState(DATA_GUNSHIP_EVENT) == DONE)
                return false;
        ...
        struct npc_muradin_gunshipAI : public ScriptedAI
        {
            ...
            void DoAction(int32 const action)
            {
                switch (action)
                {
                    ...
                    case ACTION_DONE:
                        if (Creature* allianceBoss = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_SKYBREAKER_BOSS)))
                        {
                            _instance->SendEncounterUnit(ENCOUNTER_FRAME_DISENGAGE, allianceBoss);
                            allianceBoss->DespawnOrUnsummon();
                        }

                        if (Creature* hordeBoss = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_ORGRIMMAR_HAMMER_BOSS)))
                        {
                            _instance->SendEncounterUnit(ENCOUNTER_FRAME_DISENGAGE, hordeBoss);
                            hordeBoss->DespawnOrUnsummon();
                        }
                        ...
                        events.CancelEvent(EVENT_SPAWN_MAGE);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SEND_UPDATE:
                            ...
                            //skybreaker->BuildStopMovePacket(me->GetMap());
                            events.ScheduleEvent(EVENT_SEND_UPDATE, 5000);
                            break;
                        ...
                        case EVENT_INTRO_ALLIANCE_7:
                            if (Creature* pSaurfang = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_HIGH_OVERLORD_SAURFANG_NOT_VISUAL)))
                            {
                                ...
                                pSaurfang->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                            }
                            break;
                        ...
                        case EVENT_BOARDING_GUNSHIP:
                            if (Creature* saurfang = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_HIGH_OVERLORD_SAURFANG_NOT_VISUAL)))
                        ...
                        case EVENT_OUTRO_ALLIANCE_1:
                            _instance->DoCompleteAchievement(RAID_MODE(ACHIEV_IM_ON_A_BOAT_10,ACHIEV_IM_ON_A_BOAT_25,ACHIEV_IM_ON_A_BOAT_10,ACHIEV_IM_ON_A_BOAT_25));
    ...
    public:
        ...
        struct npc_korkron_axethrower_riflemanAI : public Scripted_NoMovementAI
        {
            ...
            void Reset()
            {
                ...
                events.ScheduleEvent(EVENT_AXETHROWER_ATTACK, urand(6000, 15000));
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_AXETHROWER_ATTACK:
                            DoCastVictim(me->GetEntry() == NPC_GB_KORKRON_AXETHROWER ? SPELL_HURL_AXE : SPELL_SHOOT);
                            events.ScheduleEvent(EVENT_AXETHROWER_ATTACK, urand(6000, 15000));
                            break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_WALK_MOBS:
                        {
                            ...
                            uint32 spellDeckId = (me->GetEntry() == NPC_GB_KORKRON_SERGANTE) ? SPELL_ON_SKYBREAKERS_DECK : SPELL_ON_ORGRIMS_HAMMERS_DECK;
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                            {
                                if (target->HasAura(spellDeckId))
                                {
                                    me->GetMotionMaster()->MoveChase(target);
                                    me->AI()->AttackStart(target);
                                }
                                else
                                    events.ScheduleEvent(EVENT_WALK_MOBS, 2000);
                            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_WALK_MOBS:
                        {
                            ...
                            uint32 spellDeckId = (me->GetEntry() == NPC_GB_KORKRON_REAVERS) ? SPELL_ON_SKYBREAKERS_DECK : SPELL_ON_ORGRIMS_HAMMERS_DECK;
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                            {
                                if (target->HasAura(spellDeckId))
                                {
...
class npc_zafod_boombox : public CreatureScript
{
    public:
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            if (action == 1)
            {
                // Security, this shouldn't happen. Maybe useless.
                uint32 curItemCount = player->GetItemCount(49278, false);
                if (curItemCount >= 1)
                {
                    creature->MonsterWhisper("You already have my jetpack!", player->GetGUID());
                    return false;
                }
                ...
                {
                    creature->MonsterWhisper("You do not have empty space for my jet-pack!", player->GetGUID());
                    return false;
                }
            }
            ...
            void DoAction(int32 const action)
            {
                switch (action)
                {
                    ...
                    case ACTION_BATTLE_EVENT:
                    {
                        ...
                        Creature* hordeBoss = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_ORGRIMMAR_HAMMER_BOSS));
                        Creature* allianceBoss = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_SKYBREAKER_BOSS));

                        if (hordeBoss && allianceBoss)
                        {
                            me->SetReactState(REACT_AGGRESSIVE);
                            hordeBoss->SetInCombatWith(allianceBoss);
                            allianceBoss->SetInCombatWith(hordeBoss);
                            allianceBoss->AddThreat(hordeBoss, 0.0f);
                            hordeBoss->AddThreat(allianceBoss, 0.0f);
                            _instance->SetBossState(DATA_GUNSHIP_EVENT, IN_PROGRESS);
                            events.ScheduleEvent(EVENT_SUMMON_PORTAL, 30000);
                            RelocateTransport(hordeShip);
                    ...
                    case ACTION_DONE:
                        ...
                        StopFight(hordeShip,CheckUnfriendlyShip(me,_instance, DATA_GB_MURADIN_BRONZEBEARD));
                        events.CancelEvent(EVENT_WIPE_CHECK);
                        events.CancelEvent(EVENT_SUMMON_PORTAL);
                        events.CancelEvent(EVENT_BOARDING_GUNSHIP);
                        events.CancelEvent(EVENT_BOARDING_REAVERS_MARINE);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_INTRO_HORDE_2:
                            StopFlyShip(hordeShip);
                            StartFlyShip(CheckUnfriendlyShip(me, _instance, DATA_GB_MURADIN_BRONZEBEARD));
                            Talk(SAY_INTRO_HORDE_1);
                            break;
                        case EVENT_INTRO_HORDE_3:
                            if (Transport* enemyShip = CheckUnfriendlyShip(me, _instance, DATA_GB_MURADIN_BRONZEBEARD))
                                StopFlyShip(enemyShip);
                        ...
                        case EVENT_INTRO_HORDE_4:
                            ...
                            if (Creature* pMuradin = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_MURADIN_BRONZEBEARD_NOT_VISUAL)))
                            {
                                ...
                                pMuradin->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                            }
                            break;
                        case EVENT_INTRO_HORDE_5:
                            ...
                            break;
                        case EVENT_SUMMON_PORTAL:
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_PORTAL, 15.03016f, -7.00016f, 37.70952f, 1.55138f);
                        ...
                        case EVENT_BOARDING_GUNSHIP:
                            count = 0;
                            if (Creature* saurfang = ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_MURADIN_BRONZEBEARD_NOT_VISUAL)))
                                saurfang->AI()->Talk(SAY_BOARDING_SKYBREAKER_MURADIN);

                            if (Creature* Sergante = hordeShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_SERGANTE, 15.03016f, -7.00016f, 37.70952f, 1.55138f))
                                Sergante->CastSpell(Sergante, SPELL_TELEPORT_VISUAL, true);
                        ...
                        case EVENT_BOARDING_REAVERS_MARINE:
                            if(count <= SummonCount)
                            {
                                if(Creature* Marine = hordeShip->AddNPCPassengerInInstance(NPC_GB_SKYBREAKER_MARINE, 15.03016f, -7.00016f, 37.70952f, 1.55138f))
                                {
                        ...
                        case EVENT_SPAWN_MAGE:
                            ...
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_BATTLE_MAGE, 15.03016f, 0.00016f, 37.70952f, 1.55138f);
                            break;
                        case EVENT_RESPAWN_ROCKETEER:
                            Talk(SAY_NEW_ROCKETEERS_SPAWNED);

                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, -11.44849f, -25.71838f, 33.64343f, 1.49248f);
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, 12.30336f, -25.69653f, 35.32373f, 1.49248f);
                            if (RocketerCount == 4)
                            {
                                hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, -3.44849f, -25.71838f, 34.21082f, 1.49248f);
                                hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_ROCKETEER, 3.30336f, -25.69653f, 35.32373f, 1.49248f);
                            }
                            break;
                        case EVENT_RESPAWN_AXES_RIFLEMEN:
                            Talk(SAY_NEW_AXETHROWER_SPAWNED);

                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -3.170555f, 28.30652f, 34.21082f, 1.66527f);
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -12.0928f, 27.65942f, 33.58557f, 1.66527f);
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 14.92804f, 26.18018f, 35.47803f, 1.66527f);
                            hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 24.70331f, 25.36584f, 35.97845f, 1.66527f);
                            if (AxesCount == 6)
                            {
                                hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, 19.92804f, 27.18018f, 35.47803f, 1.66527f);
                                hordeShip->AddNPCPassengerInInstance(NPC_GB_KORKRON_AXETHROWER, -7.70331f, 28.36584f, 33.88557f, 1.66527f);
                            }
                            break;
                        default:
                            break;
