...
bool SmartAIMgr::IsEventValid(SmartScriptHolder& e)
{
    ...
    else
    {
        ...
        case SMART_EVENT_FRIENDLY_HEALTH_PCT:
            ...
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "SmartAIMgr: Entry %ld SourceType %u Event %u Action %u has pct value above 100, skipped.", e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType());
                return false;
            }
            switch (e.GetTargetType())
            {
            ...
            case SMART_TARGET_PLAYER_DISTANCE:
                break;
            default:
                TC_LOG_ERROR(LOG_FILTER_SQL, "SmartAIMgr: Entry %ld SourceType %u Event %u Action %u uses invalid target_type %u, skipped.", e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), e.GetTargetType());
                return false;
            }
            break;
