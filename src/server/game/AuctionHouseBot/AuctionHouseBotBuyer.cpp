...
{
    TC_LOG_DEBUG("auctionHouse", "AHBot: Entry %u bought at %.2fg", auction->Id, float(auction->buyout) / GOLD);
...
{
    TC_LOG_DEBUG("auctionHouse", "AHBot: Bid placed to entry %u, %.2fg", auction->Id, float(bidPrice) / GOLD);
