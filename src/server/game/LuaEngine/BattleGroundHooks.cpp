...
void Eluna::OnBGStart(BattleGround* bg, uint16 bgId, uint32 instanceId)
{
...
void Eluna::OnBGEnd(BattleGround* bg, uint16 bgId, uint32 instanceId, Team winner)
{
...
void Eluna::OnBGCreate(BattleGround* bg, uint16 bgId, uint32 instanceId)
{
...
void Eluna::OnBGDestroy(BattleGround* bg, uint16 bgId, uint32 instanceId)
{
