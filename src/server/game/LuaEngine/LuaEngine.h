...
public:
    ...
    /* Auction House */
    void OnAdd(AuctionHouseObject* ah, AuctionEntry* auction);
    void OnRemove(AuctionHouseObject* ah, AuctionEntry* auction);
    void OnSuccessful(AuctionHouseObject* ah, AuctionEntry* auction);
    void OnExpire(AuctionHouseObject* ah, AuctionEntry* auction);
    ...
    /* Battle Ground */
    void OnBGStart(BattleGround* bg, uint16 bgId, uint32 instanceId);
    void OnBGEnd(BattleGround* bg, uint16 bgId, uint32 instanceId, Team winner);
    void OnBGCreate(BattleGround* bg, uint16 bgId, uint32 instanceId);
    void OnBGDestroy(BattleGround* bg, uint16 bgId, uint32 instanceId);
};
