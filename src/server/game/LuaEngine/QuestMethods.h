...
namespace LuaQuest
{
    ...
    int HasFlag(lua_State* L, Quest* quest)
    {
        ...
        Eluna::Push(L, quest->HasFlag(static_cast<__QuestFlags>(flag)));
        return 1;
    }
    ...
    {
        Eluna::Push(L, quest->NextQuestID);
        return 1;
    }
    ...
    {
        Eluna::Push(L, quest->PrevQuestID);
        return 1;
    }
    ...
    {
        Eluna::Push(L, quest->NextQuestIdChain);
        return 1;
    }
