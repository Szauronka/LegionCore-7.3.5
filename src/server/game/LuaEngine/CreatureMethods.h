...
namespace LuaCreature
{
    ...
    */
    ...
    int GetAggroRange(lua_State* L, Creature* creature)
    {
        ...
        Eluna::Push(L, int(creature->GetAttackDist())); // can't find better option
        return 1;
    }
    ...
    */
    int GetAITarget(lua_State* L, Creature* creature)
    {
        ...
        {
            Unit* target = Unit::GetUnit(*creature, itr->getUnitGuid());
    ...
    {
        Eluna::Push(L, creature->GetCreatureTemplate()->npcflag);
        return 1;
    }
    ...
    */
    ...
    int SetNPCFlags(lua_State* L, Creature* creature)
    {
        ...
        creature->SetFlag(UNIT_FIELD_NPC_FLAGS, (NPCFlags)flags);
        return 0;
    }
    ...
    */
    ...
    int UpdateEntry(lua_State* L, Creature* creature)
    {
        ...
        creature->UpdateEntry(entry, 469U, dataGuidLow ? eObjectMgr->GetCreatureData(dataGuidLow) : NULL);
        return 0;
    }
