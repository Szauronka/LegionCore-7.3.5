...
#define ELUNA_LOG_INFO(...)     TC_LOG_INFO(LOG_FILTER_ELUNA, __VA_ARGS__);
#define ELUNA_LOG_ERROR(...)    TC_LOG_ERROR(LOG_FILTER_ELUNA, __VA_ARGS__);
#define ELUNA_LOG_DEBUG(...)    TC_LOG_DEBUG(LOG_FILTER_ELUNA, __VA_ARGS__);
