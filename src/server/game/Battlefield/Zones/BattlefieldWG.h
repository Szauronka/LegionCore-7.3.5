...
class BattlefieldWG : public Battlefield
{
    ...
    protected:
        bool m_isRelicInteractible = false;
        ...
        uint32 m_tenacityStack = 0;
        uint32 m_saveTimer = 0;

        GameObject* m_titansRelic = nullptr;
};
...
struct WGWorkshop
{
    ...
    WGWorkshop(BattlefieldWG* _bf, uint8 _workshopId): teamControl(0), state(0)
    {
